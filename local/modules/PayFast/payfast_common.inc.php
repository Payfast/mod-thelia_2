...
define( 'PF_SOFTWARE_NAME', 'Thelia' );
define( 'PF_SOFTWARE_VER', $update->getCurrentVersion() );
define( 'PF_MODULE_NAME', 'PayFast-Thelia' );
define( 'PF_MODULE_VER', '1.0.0' );
define( 'PF_DEBUG', ( PayFastConfigQuery::read( 'debug' ) == 1 ? true : false ) );
 ...
 */
function pfValidData( $pfHost = 'payfast.co.za', $pfParamString = '', $pfProxy = null )
{
    pflog( 'Host = ' . $pfHost );
